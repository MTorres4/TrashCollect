...
namespace TrashCollectorPro.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, ZipCode = model.ZipCode, City = model.City, State = model.State, Street = model.Street, FirstName = model.FirstName, LastName = model.LastName, CurrentPickUpDay = model.CurrentPickUpDay };
